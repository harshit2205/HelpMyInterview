...
public class HelpScene {
    public static Scene getScene(){
        ...
        ImageView forumLogoImageView = new ImageView(new Image("/GUI/ImageResource/github_logo.png"));
        forumLogoImageView.setFitWidth(20);
        forumLogoImageView.setFitHeight(20);
        ImageView documentationLogoImageView = new ImageView(new Image("/GUI/ImageResource/github_logo.png"));
        documentationLogoImageView.setFitWidth(20);
        documentationLogoImageView.setFitHeight(20);
        ImageView websiteForumLogoImageView = new ImageView(new Image("/GUI/ImageResource/forum_logo.png"));
